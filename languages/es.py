...
'Case Code': 'Código',
'Case Egress': 'Egreso',
'Case file children': 'Adjuntos',
'Case File Code': 'Código',
'Case File Egress': 'Egreso',
'Case file histories': 'Movimientos',
'Case File Id': 'Case File Id',
'Case File Ingress': 'Ingreso',
'Case File Letter': 'Letra',
'Case File Number': 'Número',
'Case File Status': 'Estado',
'Case File Subject': 'Asunto',
'Case File To': 'Elevado a',
'Case File User': 'Usuario',
'Case File Year': 'Año',
